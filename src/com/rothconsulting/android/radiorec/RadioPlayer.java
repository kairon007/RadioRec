...
public class RadioPlayer extends Activity {
	...
	// protected boolean isRadioRunning;
	...
	// AdMob.showAd(this);
	//
	// toggleButtonPlayStop = (ToggleButton)
	// findViewById(R.id.toggleButtonPlayStop);
	...
	// });
	//
	// toggleButtonRecordStop = (ToggleButton)
	// findViewById(R.id.toggleButtonRecordStop);
	...
	// });
	//
	// imageViewHomepage = (ImageView)
	// findViewById(R.id.ImageViewSelectedStation);
