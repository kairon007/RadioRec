...
public class RadioChooser extends Activity {
	...
	// });
	//
	// final ImageView imageViewRadio32 = (ImageView)
	// findViewById(R.id.imageViewRadio32);
	...
	// }
	// });
	// final ImageView imageViewRadio32Goldies = (ImageView)
	// findViewById(R.id.imageViewRadio32Goldies);
	// imageViewRadio32Goldies.setOnClickListener(new View.OnClickListener() {
	// public void onClick(View v) {
	// RadioPlayer.SELECTED_STATION_ICON =
	// R.drawable.logo_radio32_goldies_42x40;
	...
	// }
	// });
	// final ImageView imageViewRadio24 = (ImageView)
	// findViewById(R.id.imageViewRadio24);
	...
	// }
	// });
	// final ImageView imageViewRadio24Rock = (ImageView)
	// findViewById(R.id.imageViewRadio24Rock);
	...
	// }
	// });
	// final ImageView imageViewRadioEnergyBern = (ImageView)
	// findViewById(R.id.imageViewRadioEnergyBern);
	...
	// Constants.URL_LIVE_STREAM_RADIO_ENERGY_BERN;
	...
	// }
	// });
	// final ImageView imageViewRadioEnergyZuerich = (ImageView)
	// findViewById(R.id.imageViewRadioEnergyZurich);
	// imageViewRadioEnergyZuerich
	// .setOnClickListener(new View.OnClickListener() {
	// public void onClick(View v) {
	// RadioPlayer.SELECTED_STATION_ICON = R.drawable.logo_energy_zuerich_75x36;
	// RadioPlayer.URL_LIVE_STREAM =
	// Constants.URL_LIVE_STREAM_RADIO_ENERGY_ZUERICH;
	...
	// }
	// });
	// final ImageView imageViewRadioEnergySwiss = (ImageView)
	// findViewById(R.id.imageViewRadioEnergySwiss);
	// imageViewRadioEnergySwiss
	// .setOnClickListener(new View.OnClickListener() {
	// public void onClick(View v) {
	// RadioPlayer.SELECTED_STATION_ICON = R.drawable.logo_energy_swiss_75x36;
	// RadioPlayer.URL_LIVE_STREAM =
	// Constants.URL_LIVE_STREAM_RADIO_ENERGY_SWISS;
	...
	// });
	//
	// final ImageView imageViewRadioCapitalFM = (ImageView)
	// findViewById(R.id.imageViewRadioCapitalFM);
	...
	// }
	// });
	// final ImageView imageViewRadioHoch2 = (ImageView)
	// findViewById(R.id.imageViewRadioHoch2);
	...
	// }
	// });
	// final ImageView imageViewRadioDRS1 = (ImageView)
	// findViewById(R.id.imageViewRadioDRS1);
	...
	// }
	// });
	// final ImageView imageViewRadioDRS2 = (ImageView)
	// findViewById(R.id.imageViewRadioDRS2);
	...
	// }
	// });
	// final ImageView imageViewRadioDRS3 = (ImageView)
	// findViewById(R.id.imageViewRadioDRS3);
	...
	// }
	// });
	// final ImageView imageViewRadioDRS4News = (ImageView)
	// findViewById(R.id.imageViewRadioDRS4News);
	...
	// }
	// });
	// final ImageView imageViewRadioDRSVirus = (ImageView)
	// findViewById(R.id.imageViewRadioDRSVirus);
	...
	// }
	// });
	// final ImageView imageViewRadioRaBe = (ImageView)
	// findViewById(R.id.imageViewRadioRaBe);
	...
	// }
	// });
	// final ImageView imageViewRadioSwissJazz = (ImageView)
	// findViewById(R.id.imageViewRadioSwissJazz);
	...
	// }
	// });
	// final ImageView imageViewRadioSwissPop = (ImageView)
	// findViewById(R.id.imageViewRadioSwissPop);
	...
	// }
	// });
	// final ImageView imageViewRadioSwissClassic = (ImageView)
	// findViewById(R.id.imageViewRadioSwissClassic);
	// imageViewRadioSwissClassic
	// .setOnClickListener(new View.OnClickListener() {
	// public void onClick(View v) {
	// RadioPlayer.SELECTED_STATION_ICON = R.drawable.logo_swiss_classic_120x30;
	// RadioPlayer.URL_LIVE_STREAM =
	// Constants.URL_LIVE_STREAM_RADIO_SWISS_CLASSIC;
	...
	// }
	// });
	// final ImageView imageViewRadio1 = (ImageView)
	// findViewById(R.id.imageViewRadio1);
	...
	// }
	// });
	// final ImageView imageViewRadioZuerisee = (ImageView)
	// findViewById(R.id.imageViewRadioZuerisee);
	...
	// }
	// });
	// final ImageView imageViewRadioPilatus = (ImageView)
	// findViewById(R.id.imageViewRadioPilatus);
	...
	// }
	// });
	// final ImageView imageViewRadioBeO = (ImageView)
	// findViewById(R.id.imageViewRadioBeO);
	...
	// }
	// });
	// final ImageView imageViewRadioTop = (ImageView)
	// findViewById(R.id.imageViewRadioTop);
	...
	// }
	// });
	// final ImageView imageViewRadioTopTwo = (ImageView)
	// findViewById(R.id.imageViewRadioTopTwo);
	...
	// }
	// });
	// final ImageView imageViewRadio20min = (ImageView)
	// findViewById(R.id.imageViewRadio20min);
	...
	// }
	// });
	// final ImageView imageViewRadioNeo1 = (ImageView)
	// findViewById(R.id.imageViewRadioNeo1);
	...
	// }
	// });
	// final ImageView imageViewRadioNeoZwei = (ImageView)
	// findViewById(R.id.imageViewRadioNeoZwei);
	...
	// }
	// });
	// final ImageView imageViewRadioBasel = (ImageView)
	// findViewById(R.id.imageViewRadioBasel);
	...
	// final TableRow tableRowRadioArgovia = (TableRow)
	// findViewById(R.id.tableRowArgovia);
	// tableRowRadioArgovia.removeAllViews();
	// tableRowRadioArgovia.setVisibility(View.INVISIBLE);
	// final TableRow tableRowRadioArgoviaHitmix = (TableRow)
	// findViewById(R.id.tableRowArgoviaHitmix);
	// tableRowRadioArgoviaHitmix.removeAllViews();
	// tableRowRadioArgoviaHitmix.setVisibility(View.INVISIBLE);
	// final TableRow tableRowRadioArgoviaClassicRock = (TableRow)
	// findViewById(R.id.tableRowArgoviaClassicRock);
	// tableRowRadioArgoviaClassicRock.removeAllViews();
	// tableRowRadioArgoviaClassicRock.setVisibility(View.INVISIBLE);
	// final TableRow tableRowRadio105 = (TableRow)
	// findViewById(R.id.tableRow105);
	// tableRowRadio105.removeAllViews();
	// tableRowRadio105.setVisibility(View.INVISIBLE);
	// } else {
	// final ImageView imageViewRadioArgovia = (ImageView)
	// findViewById(R.id.imageViewRadioArgovia);
	...
	// }
	// });
	// final ImageView imageViewRadioArgoviaHitmix = (ImageView)
	// findViewById(R.id.imageViewRadioArgoviaHitmix);
	// imageViewRadioArgoviaHitmix
	// .setOnClickListener(new View.OnClickListener() {
	// public void onClick(View v) {
	// RadioPlayer.SELECTED_STATION_ICON = R.drawable.logo_radio_argovia_40x40;
	// RadioPlayer.URL_LIVE_STREAM =
	// Constants.URL_LIVE_STREAM_RADIO_ARGOVIA_HITMIX;
	// RadioPlayer.URL_HOMEPAGE = Constants.URL_HOMEPAGE_RADIO_ARGOVIA;
	...
	// }
	// });
	// final ImageView imageViewRadioArgoviaClassicRock = (ImageView)
	// findViewById(R.id.imageViewRadioArgoviaClassicRock);
	// imageViewRadioArgoviaClassicRock
	// .setOnClickListener(new View.OnClickListener() {
	// public void onClick(View v) {
	// RadioPlayer.SELECTED_STATION_ICON = R.drawable.logo_radio_argovia_40x40;
	// RadioPlayer.URL_LIVE_STREAM =
	// Constants.URL_LIVE_STREAM_RADIO_ARGOVIA_CLASSIC_ROCK;
	// RadioPlayer.URL_HOMEPAGE = Constants.URL_HOMEPAGE_RADIO_ARGOVIA;
	// RadioPlayer.SELECTED_STATION =
	// getString(R.string.radio_argovia_classic_rock);
	// RadioPlayer.URL_WEBCAM = Constants.URL_WEBCAM_RADIO_ARGOVIA;
	// RadioPlayer.URL_CONTACT = Constants.URL_CONTACT_RADIO_ARGOVIA;
	// finalTaks();
	// }
	// });
	// final ImageView imageViewRadio105 = (ImageView)
	// findViewById(R.id.imageViewRadio105);
	...
	// });
	// }
	// final ImageView imageViewRadioFM1 = (ImageView)
	// findViewById(R.id.imageViewRadioFM1);
	...
	// }
	// });
	// final ImageView imageViewRadioAntenneBayern = (ImageView)
	// findViewById(R.id.imageViewRadioAntenneBayern);
	// imageViewRadioAntenneBayern
	// .setOnClickListener(new View.OnClickListener() {
	// public void onClick(View v) {
	// RadioPlayer.SELECTED_STATION_ICON =
	// R.drawable.logo_radio_antenne_bayern_79x40;
	// RadioPlayer.URL_LIVE_STREAM =
	// Constants.URL_LIVE_STREAM_RADIO_ANTENNE_BAYERN;
	...
	// }
	// });
	// final ImageView imageViewRadioAntenneChillout = (ImageView)
	// findViewById(R.id.imageViewRadioAntenneChillout);
	...
	// R.drawable.logo_radio_antenne_bayern_79x40;
	// RadioPlayer.URL_LIVE_STREAM =
	// Constants.URL_LIVE_STREAM_RADIO_ANTENNE_CHILLOUT;
	// RadioPlayer.URL_HOMEPAGE = Constants.URL_HOMEPAGE_RADIO_ANTENNE_BAYERN;
	// RadioPlayer.SELECTED_STATION =
	// getString(R.string.radio_antenne_chillout);
	// RadioPlayer.URL_WEBCAM = Constants.URL_WEBCAM_RADIO_ANTENNE_BAYERN;
	// RadioPlayer.URL_CONTACT = Constants.URL_CONTACT_RADIO_ANTENNE_BAYERN;
	// finalTaks();
	// }
