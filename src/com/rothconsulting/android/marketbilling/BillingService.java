...
public class BillingService extends Service implements ServiceConnection {
	...
	abstract class BillingRequest {
		...
		protected Bundle makeRequestBundle(String method) {
			...
			request.putString(Constants.BILLING_REQUEST_PACKAGE_NAME,
					getPackageName());
			return request;
		}
	...
	class RequestPurchase extends BillingRequest {
		...
		protected long run() throws RemoteException {
			...
			request.putString(Constants.BILLING_REQUEST_ITEM_ID, mProductId);
	...
	private boolean bindToMarketBillingService() {
		try {
			...
			boolean bindResult = bindService(new Intent(
					Constants.MARKET_BILLING_SERVICE_ACTION), this, // ServiceConnection.
